$(() => {
	const apiUrl = './sql/';
	// if (!permissions.contacts) document.location.href = 'logout.php';
	const generateLiTemplate = (i, nested) => {
			...
			<li class="menu__item menu__item--switcher">
				<ul class="collapsible">
					<li 
						...
						<div class="collapsible-header">
							...
							>
								<span class="link-icon" ${i.isActive ? '' : "style='color: rgb(208, 208, 208)' "}>
									${i.iconPath}
								</span>
								<span class="menu-link" ${i.isActive ? '' : "style='color: rgb(208, 208, 208)' "}>${i.title}</span>
				...
				return el.permZone ? `
									<li data-toggle="tooltip" 
										...
										<a 
											href='${el.href}' 
											class="nav-tooltipped menu__link ${el.isActive ? '' : 'inactive'}"
											
										>
											<span class="link-icon" ${el.isActive ? '' : "style='color: rgb(208, 208, 208)' "}>
												${el.iconPath}
											</span>
											<span class="menu-link" ${el.isActive ? '' : "style='color: rgb(208, 208, 208)' "}>${el.title}</span>
										</a>
		...
		return i.permZone ? `
			...
			>
				<a 
					href='${i.href}' 
					class="nav-tooltipped menu__link ${i.isActive ? '' : 'inactive'}">
					<span class="link-icon" ${i.isActive ? '' : "style='color: rgb(208, 208, 208)' "}>
						${i.iconPath}
					</span>
					<span class="menu-link" ${i.isActive ? '' : "style='color: rgb(208, 208, 208)' "}>${i.title}</span>
	...
	const data = [
		{
			...
			title: 'Items',
			collapsible: true,
			iconPath: `<svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="tag" class="svg-inline--fa fa-tag fa-w-16 svg-icon" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M0 252.118V48C0 21.49 21.49 0 48 0h204.118a48 48 0 0 1 33.941 14.059l211.882 211.882c18.745 18.745 18.745 49.137 0 67.882L293.823 497.941c-18.745 18.745-49.137 18.745-67.882 0L14.059 286.059A48 48 0 0 1 0 252.118zM112 64c-26.51 0-48 21.49-48 48s21.49 48 48 48 48-21.49 48-48-21.49-48-48-48z"></path></svg>`,
			permZone: {},
			innerLinks: [
				{
					href: 'search-item.php',
					tooltipPosition: 'right',
					tooltip: 'Search Item',
					title: 'Search Item',
				...
				{
					href: `${selectedItemId !== 0 ? 'item-details.php' : 'javascript:void(0);'}`,
					tooltipPosition: 'right',
		...
		},
		{
			...
			title: 'Products',
			collapsible: true,
			iconPath: `<svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="tags" class="svg-inline--fa fa-tags fa-w-20 svg-icon" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><path fill="currentColor" d="M497.941 225.941L286.059 14.059A48 48 0 0 0 252.118 0H48C21.49 0 0 21.49 0 48v204.118a48 48 0 0 0 14.059 33.941l211.882 211.882c18.744 18.745 49.136 18.746 67.882 0l204.118-204.118c18.745-18.745 18.745-49.137 0-67.882zM112 160c-26.51 0-48-21.49-48-48s21.49-48 48-48 48 21.49 48 48-21.49 48-48 48zm513.941 133.823L421.823 497.941c-18.745 18.745-49.137 18.745-67.882 0l-.36-.36L527.64 323.522c16.999-16.999 26.36-39.6 26.36-63.64s-9.362-46.641-26.36-63.64L331.397 0h48.721a48 48 0 0 1 33.941 14.059l211.882 211.882c18.745 18.745 18.745 49.137 0 67.882z"></path></svg>`,
			permZone: {},
			isActive: true,
			innerLinks: [
				{
				...
				{
					href: `${selectedProductId !== 0 ? 'product-details.php' : 'javascript:void(0);'}`,
					tooltipPosition: 'right',
		...
		},
		{
			...
			title: 'Funnels',
			collapsible: true,
			iconPath: `<svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="random" class="svg-inline--fa fa-random fa-w-16 svg-icon" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M504.971 359.029c9.373 9.373 9.373 24.569 0 33.941l-80 79.984c-15.01 15.01-40.971 4.49-40.971-16.971V416h-58.785a12.004 12.004 0 0 1-8.773-3.812l-70.556-75.596 53.333-57.143L352 336h32v-39.981c0-21.438 25.943-31.998 40.971-16.971l80 79.981zM12 176h84l52.781 56.551 53.333-57.143-70.556-75.596A11.999 11.999 0 0 0 122.785 96H12c-6.627 0-12 5.373-12 12v56c0 6.627 5.373 12 12 12zm372 0v39.984c0 21.46 25.961 31.98 40.971 16.971l80-79.984c9.373-9.373 9.373-24.569 0-33.941l-80-79.981C409.943 24.021 384 34.582 384 56.019V96h-58.785a12.004 12.004 0 0 0-8.773 3.812L96 336H12c-6.627 0-12 5.373-12 12v56c0 6.627 5.373 12 12 12h110.785c3.326 0 6.503-1.381 8.773-3.812L352 176h32z"></path></svg>`,
			permZone: {},
			isActive: true,
			innerLinks: [
				{
		...
		},
		{
			href: 'javascript:void(0);',
			tooltipPosition: 'right',
			tooltip: 'Sales Schedules',
			title: 'Sales Schedules',
			collapsible: true,
			iconPath: `<svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="calendar-alt" class="svg-inline--fa fa-calendar-alt fa-w-14 svg-icon" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path fill="currentColor" d="M148 288h-40c-6.6 0-12-5.4-12-12v-40c0-6.6 5.4-12 12-12h40c6.6 0 12 5.4 12 12v40c0 6.6-5.4 12-12 12zm108-12v-40c0-6.6-5.4-12-12-12h-40c-6.6 0-12 5.4-12 12v40c0 6.6 5.4 12 12 12h40c6.6 0 12-5.4 12-12zm96 0v-40c0-6.6-5.4-12-12-12h-40c-6.6 0-12 5.4-12 12v40c0 6.6 5.4 12 12 12h40c6.6 0 12-5.4 12-12zm-96 96v-40c0-6.6-5.4-12-12-12h-40c-6.6 0-12 5.4-12 12v40c0 6.6 5.4 12 12 12h40c6.6 0 12-5.4 12-12zm-96 0v-40c0-6.6-5.4-12-12-12h-40c-6.6 0-12 5.4-12 12v40c0 6.6 5.4 12 12 12h40c6.6 0 12-5.4 12-12zm192 0v-40c0-6.6-5.4-12-12-12h-40c-6.6 0-12 5.4-12 12v40c0 6.6 5.4 12 12 12h40c6.6 0 12-5.4 12-12zm96-260v352c0 26.5-21.5 48-48 48H48c-26.5 0-48-21.5-48-48V112c0-26.5 21.5-48 48-48h48V12c0-6.6 5.4-12 12-12h40c6.6 0 12 5.4 12 12v52h128V12c0-6.6 5.4-12 12-12h40c6.6 0 12 5.4 12 12v52h48c26.5 0 48 21.5 48 48zm-48 346V160H48v298c0 3.3 2.7 6 6 6h340c3.3 0 6-2.7 6-6z"></path></svg>`,
			permZone: {},
			isActive: true,
			innerLinks: []
		},
	...
	// 				iconPath: `<svg aria-hidden="true" viewBox="0 0 384 512" focusable="false" data-prefix="fas" data-icon="question" class="svg-inline--fa fa-question fa-w-12 svg-icon" role="img" xmlns="http://www.w3.org/2000/svg">
	...
	// 				tooltip: 'Purchases',
	// 				title: 'Purchases',
	// 				iconPath: `<svg aria-hidden="true" viewBox="0 0 576 512" focusable="false" data-prefix="fas" data-icon="shopping-cart" class="svg-inline--fa fa-shopping-cart fa-w-18 svg-icon" role="img" xmlns="http://www.w3.org/2000/svg">
	...
	// 				title: 'Transactions',
	// 				iconPath: `<svg aria-hidden="true" viewBox="0 0 288 512" focusable="false" data-prefix="fas" data-icon="dollar-sign" class="svg-inline--fa fa-dollar-sign fa-w-9 svg-icon" role="img" xmlns="http://www.w3.org/2000/svg">
	...
	// 				tooltip: 'ESA Letters',
	// 				title: 'ESA Letters',
	// 				iconPath: `<svg aria-hidden="true" viewBox="0 0 512 512" focusable="false" data-prefix="far" data-icon="envelope" class="svg-inline--fa fa-envelope fa-w-16 svg-icon" role="img" xmlns="http://www.w3.org/2000/svg">
	...
	// 				iconPath: `<svg aria-hidden="true" viewBox="0 0 512 512" focusable="false" data-prefix="fas" data-icon="paper-plane" class="svg-inline--fa fa-paper-plane fa-w-16 svg-icon" role="img" xmlns="http://www.w3.org/2000/svg">
	...
	// 				iconPath: `<svg aria-hidden="true" viewBox="0 0 448 512" focusable="false" data-prefix="fab" data-icon="wpforms" class="svg-inline--fa fa-wpforms fa-w-14 svg-icon" role="img" xmlns="http://www.w3.org/2000/svg">
	...
	// 	},
		...
		},
		{
			...
			tooltip: 'Tickets',
			title: 'Tickets',
			iconPath: `<svg aria-hidden="true" viewBox="0 0 384 512" focusable="false" data-prefix="fas" data-icon="clipboard-list" class="svg-inline--fa fa-sign-out-alt fa-w-16 svg-icon" role="img" xmlns="http://www.w3.org/2000/svg">
			<path fill="currentColor" d="M336 64h-80c0-35.3-28.7-64-64-64s-64 28.7-64 64H48C21.5 64 0 85.5 0 112v352c0 26.5 21.5 48 48 48h288c26.5 0 48-21.5 48-48V112c0-26.5-21.5-48-48-48zM96 424c-13.3 0-24-10.7-24-24s10.7-24 24-24 24 10.7 24 24-10.7 24-24 24zm0-96c-13.3 0-24-10.7-24-24s10.7-24 24-24 24 10.7 24 24-10.7 24-24 24zm0-96c-13.3 0-24-10.7-24-24s10.7-24 24-24 24 10.7 24 24-10.7 24-24 24zm96-192c13.3 0 24 10.7 24 24s-10.7 24-24 24-24-10.7-24-24 10.7-24 24-24zm128 368c0 4.4-3.6 8-8 8H168c-4.4 0-8-3.6-8-8v-16c0-4.4 3.6-8 8-8h144c4.4 0 8 3.6 8 8v16zm0-96c0 4.4-3.6 8-8 8H168c-4.4 0-8-3.6-8-8v-16c0-4.4 3.6-8 8-8h144c4.4 0 8 3.6 8 8v16zm0-96c0 4.4-3.6 8-8 8H168c-4.4 0-8-3.6-8-8v-16c0-4.4 3.6-8 8-8h144c4.4 0 8 3.6 8 8v16z"></path>
	</svg>`,
			permZone: {},
			isActive: true
