	...
	<div id="main-wrapper" class="container-fluid main-wrapper">
		...
		<main class="main">
			...
			<div id="dashboard-wrapper" class="container-fluid dashboard-wrapper">
				<section id="transactions-section" class="tab-section transactions-section">
					<div class="row header-block header-block--wider">
						<div class="header-block__container">
							<h3 class="header-block__title">Transactions</h3>
						</div>
					</div>
					<br />
					<div class="row">
						<div class="col s12">
							<table class="table transactions-table highlight"></table>
						</div>
					</div>
