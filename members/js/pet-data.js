(() => {
		...
		*/
			...
			if (petsData.length === 2) {
				...
				petsData.forEach((pet, i) => {
					...
					// carousel.append(
					// 	`<div class="carousel-item item" id="">
          //     <div class="card">
          ...
          //               <input type="file" />
					...
					// 											<svg class="svg-cancel" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="black" width="24px" height="24px"><path d="M0 0h24v24H0z" fill="none"/><path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"/></svg>
					// 										</div>
					// 									</div>
					// 								</li>
					// 								<li class="breed">
					...
					// 								<li class="weight">
					// 									<div class="li-wrapper">
					// 										<span>Weight in lbs: </span><span></span>
					// 										<i class="material-icons edit-pet-info">edit</i>
					// 										<div class="edit-pet-info-icons">
					// 											<svg class="svg-apply" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24px"><path d="M0 0h24v24H0z" fill="none"/><path d="M9 16.2L4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4L9 16.2z"/></svg>
					// 											<svg class="svg-cancel" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="black" width="24px" height="24px"><path d="M0 0h24v24H0z" fill="none"/><path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"/></svg>
					...
					// 											Cat <input type="radio" name="inlineRadioOptions" id="inlineRadio1" value="2" disabled> 
					// 										</label>
					// 										<label class="radio-inline">
					// 										 	Dog <input type="radio" name="inlineRadioOptions" id="inlineRadio2" value="1" disabled> 
					// 										</label>
					// 									</div>
					// 								</li> -->
					// 							</ul>
          ...
          //   </div>`
					...
					// $('.edit-sign input').change(readURL);
				...
				console.log(0)
				// const emptyPetObj = { breed: '', contact_id: '', is_active: '', op_order: '', pet_id: '', pet_type_id: '', title: '', weight: '' };
				// petsData = Array(2).fill(emptyPetObj);
				// petsData.forEach((pet, i) => {
					const carousel = $('section#pets-section .carousel .carousel-inner');
				// 	carousel.append(displayEmptyPetsData(pet, i, petsData));
				...
				// 					// 				display: flex">
				// 					// 					<img src="img/icons/icon-circle.svg" />
				// 					// 					<img src="img/icons/icon-palm.svg" style="position: absolute; top: 50%;
				// 					// 					left: 50%;
				...
				// 					$('.edit-btn')
				// 						.before(
				// 							`<div class="pet-palm" style="position: relative; width: 250px; height: 250px; display: flex">
				// 								<img src="img/icons/icon-circle.svg" />
				// 								<img src="img/icons/icon-palm.svg" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);" />
				// 							</div>`
				// 						)
	...
	function displayPetsData(pet, i, data) {
		...
		return `<div class="carousel-item item ${i === 0 ? 'active' : ''}" id=${pet.pet_id} data-order=${pet.op_order} data-type=${pet.pet_type_id}>
              <div class="card">
                <div class="card-image">
									<div class="input-field profile-photo__pic">
										<div class="pic-edit">
