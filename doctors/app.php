...
<div class="container">
        <main class="app-block">
                ...
                <div class="hidden app-block__menu">
                    <ul class="list">
                        <li class="list__item">
                ...
                <div class="app-block__review-title">
                    <h3>Patients available for review:</h3>
                    <p>Summary Account of ESAs: <span></span></p>
                </div>
                <div class="second-page"></div>
                <table class="users-table highlight">
                    <tbody>
                    </tbody>
                </table>
        </main>
...
<script src="https://cdn.jsdelivr.net/npm/jquery-validation@1.19.2/dist/additional-methods.min.js"></script>
    ...
    <script>
        const currDoctorId = <?php echo $_SESSION["id"]; ?>;
