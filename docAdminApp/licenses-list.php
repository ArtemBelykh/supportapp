...
// $selectedId = ( isset($_GET["selectedId"]) )? mysqli_real_escape_string($link, $_GET["selectedId"]) : 0;
// if ( !isset($_SESSION["selectedId"]) || $_SESSION["selectedId"] !== 0  ) { $_SESSION["selectedId"]=0; }
  ...
  <div id="main-wrapper" class="container-fluid main-wrapper">
    ...
    <main class="main">
      <div id="dashboard-wrapper" class="container-fluid dashboard-wrapper">
        <section id="licenses-list-section" class="tab-section licenses-list-section">
          <div class="row">
