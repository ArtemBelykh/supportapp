...
// *** *** *** 
$sql_1 = "SELECT * FROM v_op_contacts_01 WHERE contact_id=".$id;
// $sql_1 = "SELECT * FROM v_op_contacts_01 where contact_id=2240";
$result_1 = mysqli_query($link, $sql_1) or die('{"message":"error1"}');
$arrMain_1 = array();
...
$sql_2 = "SELECT * FROM v_addresses_01 WHERE contact_id=".$id;
$sql_2.= " ORDER BY dlm DESC LIMIT 1";
$result_2 = mysqli_query($link, $sql_2) or die('{"message":"error2"}');
$arrMain_2 = array();
