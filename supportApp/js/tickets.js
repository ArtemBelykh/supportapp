          ...
          <form>
            <div class="container">
              ...
              <div class="form-create-message__footer btn-group-container d-flex">
				...
				${generateBtn('Cancel', undefined, 'CancelForwardMessage', '', 'form-create-message__remove btn-danger cancel_btn')}
			    <style>
					.cancel_btn {
						margin-left: 10px;
					}
          ...
          <form>
            <div class="container">
              ...
              <div class="form-create-message__footer">
                ...
                ${generateBtn('Cancel', undefined, 'CancelReplyAllMessage', '', 'form-create-message__remove btn-danger cancel_btn')}
              </div>
            </div>
          </form>
        </div>
...
<div class="tickets__subj_container" style="display: flex;align-items: center;">
    ...
    <select onchange="window.location.href = '/supportApp/tickets.php'" id="statuses" class="get_ticket_status" style="width: 150px;height: 40px;font-family: 'Book Antiqua'; font-size: 16px;letter-spacing: 1.5px; position: absolute;right: 30px;"></select>
</div>
                  ...
                  if (toEmployeeIds.length) {
                    Promise.all(toEmployeeIds.map(id => sendId(id, noteBodyId)))
                      .then(r => {
                        ...
                        window.location.href = '/supportApp/tickets.php'
                      })
